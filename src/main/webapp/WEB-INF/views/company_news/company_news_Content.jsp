				...
				<table width="1000" cellspacing="0" class="table table-hover">
					<tr>
						<c:choose>
							...
							<c:otherwise>
								<td><c:url var="company_newsContentUrl"
									...
									</c:url> <a href="${company_newsContentUrl}">다음글 :
										${NextnewsDto.news_title}</a></td>
							</c:otherwise>
						</c:choose>
					</tr>
					...
					<tr>
						<c:choose>
							...
							<c:otherwise>
								<td><c:url var="company_newsContentUrll"
										value="company_news_Content.do">
										<c:param name="news_idx">${PreviousnewsDto.news_idx}</c:param>
										<c:param name="com_idx">${dto.getCom_idx()}</c:param>
									</c:url> <a href="${company_newsContentUrll}">이전글 :
										${PreviousnewsDto.news_title}</a></td>
							</c:otherwise>
						</c:choose>
					</tr>
				</table>
